...
function lendPairAavePublic(pair){
    var config = {
        method: 'get',
        url: 'http://orcadefi.com/api/v1/realtime/aave/lend/?pair='+ pair
    };
    axios(config).then(function (response) {console.log(JSON.stringify(response.data));}).catch(function (error) {console.log(error);});
}
...
function lendPairCompoundPublic(pair){
    var config = {
        method: 'get',
        url: 'http://orcadefi.com/api/v1/realtime/compound/lend/?pair='+ pair
    };
    axios(config).then(function (response) {console.log(JSON.stringify(response.data));}).catch(function (error) {console.log(error);});
}
...
function borrowPairCompoundPublic(pair){
    var config = {
        method: 'get',
        url: 'http://orcadefi.com/api/v1/realtime/compound/borrow/?pair='+ pair
    };
    axios(config).then(function (response) {console.log(JSON.stringify(response.data));}).catch(function (error) {console.log(error);});
}
...
function lendPairDydxPublic(pair){
    var config = {
        method: 'get',
        url: 'http://orcadefi.com/api/v1/realtime/dydx/lend/?pair='+ pair
    };
    axios(config).then(function (response) {console.log(JSON.stringify(response.data));}).catch(function (error) {console.log(error);});
}

function borrowPairDydPublicx(pair){
    var config = {
        method: 'get',
        url: 'http://orcadefi.com/api/v1/realtime/dydx/borrow/?pair='+ pair
    };
    axios(config).then(function (response) {console.log(JSON.stringify(response.data));}).catch(function (error) {console.log(error);});
}
...
function lendPairFulcrumPublic(pair){
    var config = {
        method: 'get',
        url: 'http://orcadefi.com/api/v1/realtime/fulcrum/lend/?pair='+ pair
    };
    axios(config).then(function (response) {console.log(JSON.stringify(response.data));}).catch(function (error) {console.log(error);});
}
...
function borrowPairFulcrumPublic(pair){
    var config = {
        method: 'get',
        url: 'http://orcadefi.com/api/v1/realtime/fulcrum/borrow/?pair='+ pair
    };
    axios(config).then(function (response) {console.log(JSON.stringify(response.data));}).catch(function (error) {console.log(error);});
}
